...
jQuery(document).ready(function(){
	jQuery('.tiva-timetable').each(function(index) {
		...
		var data_params = '';
		if(typeof jQuery(this).attr('id-periode') != 'undefined' && typeof jQuery(this).attr('tipe-bertugas') != 'undefined'){
			data_params = { id_periode :  jQuery(this).attr('id-periode'), mode_bertugas :  jQuery(this).attr('tipe-bertugas')};
		}
		if(typeof jQuery(this).attr('id-periode') != 'undefined' && typeof jQuery(this).attr('id-admin') != 'undefined'){
			data_params = { id_periode :  jQuery(this).attr('id-periode'), id_admin :  jQuery(this).attr('id-admin')};
		}
        var source = 'php';
        var url_json = '';
        var base_url = jQuery(this).attr('data-url');
        if(jQuery(this).attr('data-source') == 'all_admin'){
            url_json = base_url + '/jadwal/json_all_admin';
        }
        else if(jQuery(this).attr('data-source') == 'data_bertugas_admin'){
        	url_json = base_url + '/jadwal/json_jadwal_bertugas';
        }
        else if(jQuery(this).attr('data-source') == 'ind_admin'){
        	url_json = base_url + '/jadwal/json_individual_admin';
        }
        else if(jQuery(this).attr('data-source') == 'all_ruangan'){
        	url_json =  base_url + '/jadwal/json_all_ruangan';
        }
		...
		if (source == 'json') { // Get timetables from json file
			...
			jQuery.ajax({
				...
				method: "GET",
				beforeSend : function(){
					timetable_contain.html('<div class="loading"><img src="'+base_url+'/assets/img/loading.gif" /></div>');
				},
