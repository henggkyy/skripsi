        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="ibox-content">
                    <h4>Form Peminjaman Laboratorium</h4>
                    <hr>
                    <?php echo form_open('peminjaman_lab/add');?>
                    <?php $this->load->view('template/Notification');?>
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label">Pilih Laboratorium <span style="color: red">*</span> :</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea placeholder="Dapat diisi dengan keperluan peminjaman lab, kebutuhan, dsb." name="keterangan" class="form-control"></textarea>
                        </div>
                    </div>
                    <p style="color: red;" align="center">* Wajib Diisi</p>
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <a href="<?php echo base_url();?>peminjaman" class="btn btn-white btn-lg"> < Back</a>
