                                        ...
                                        <li><h4>Administrasi Akademik</h4>
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <button data-toggle="modal" data-target="#insertJadwal" class="btn btn-success btn-sm" type="submit"><i class="fas fa-group"></i> Insert Jadwal Kelas</button>
                                                      <!--START MODAL Insert Jadwal Kelas-->
                                                        <div class="modal inmodal" id="insertJadwal" tabindex="-1" role="dialog"  aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content animated fadeIn">
                                                                    <div class="modal-header">
                                                                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                                                        <h3 class="modal-title">Insert Jadwal Kelas - <?php echo $nama_matkul;?></h3>
                                                                    </div>
